...
class ReadingCamera extends StatefulWidget {
  final Tbl_mkrt_unit mkrtUnit;
  final Menu menu;
  final String meteran;
  ...
  ReadingCamera(
      ...
      : super(key: key);
  @override
  _ReadingCameraState createState() => _ReadingCameraState();
}

class _ReadingCameraState extends State<ReadingCamera> {
  ...
  saveOK() async {
    ...
    if (table == 'tbl_waters') {
      ...
      if (check == null) {
        ...
        dataSave.problem = '1';
        dataSave.nomor_seri = meteran;
        dataSave.pemakaian = pemakaian;
        dataSave.foto = img64;
      ...
      final resDel = await Tbl_waters_temp_problem()
          .select()
          .unit_code
          .equals(paramUnitCode)
          .delete();
      ...
      final resDel = await Tbl_electrics_temp_problem()
          .select()
          .unit_code
          .equals(paramUnitCode)
          .delete();
  ...
  void initState() {
    ...
    displayCamera();
    img64 = widget.img64;
    meteran = widget.meteran;
    pemakaian = widget.pemakaian;
    print("=====================> " + img64);
    print("=====================> " + meteran);
    print("=====================> " + pemakaian);
  }
